    ...
    <footer className="grid grid-cols-1 md:(grid-cols-3) border-t border-gray-300 bg-gray-200 px-4">
      <div className="m-4 sm:m-6 flex-1">
        ...
        <p className="text-justify text-gray-700">
          “Our fashion store brings curated styles crafted to inspire confidence
          in every moment, offering modern pieces designed for comfort and
          expression in daily wear or special occasions, blending quality
          materials with thoughtful details to elevate your personal wardrobe
          effortlessly.”
        </p>
        <ul className="flex mt-6 justify-center md:justify-start space-x-4">
          ...
          <li>
            <a href="https://github.com/nguyentantu230704/Final_TMDT.git">
              <GitHub />
            </a>
          </li>
          <li>
      ...
      <div className="m-4 sm:m-6">
        <h2 className="text-xl text-center md:text-left font-medium mb-4">
          Useful Links
        </h2>
      ...
      <div className="m-4 sm:m-6">
        ...
        <ul className="space-y-3 text-gray-700">
          ...
          <li className="flex items-center">
            ...
            <a href="mailto:nguyentantu230704@gmail.com" target="_blank">
              nguyentantu230704@gmail.com
            </a>
          </li>
          <li className="flex items-center">
            <GitHub className="w-5 h-5 mr-2" />
            <a
              href="https://github.com/nguyentantu230704/Final_TMDT.git"
              target="_blank"
            >
              /Fashion-Store
            </a>
